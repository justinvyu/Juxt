...
// MPCoachMarks
#define COCOAPODS_POD_AVAILABLE_MPCoachMarks
#define COCOAPODS_VERSION_MAJOR_MPCoachMarks 0
#define COCOAPODS_VERSION_MINOR_MPCoachMarks 0
#define COCOAPODS_VERSION_PATCH_MPCoachMarks 7
