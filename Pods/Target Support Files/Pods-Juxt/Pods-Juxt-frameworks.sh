...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Juxt/Bond.framework"
  ...
  install_framework "Pods-Juxt/FLAnimatedImage.framework"
  install_framework "Pods-Juxt/LLSimpleCamera.framework"
  install_framework "Pods-Juxt/MBProgressHUD.framework"
  install_framework "Pods-Juxt/MBSimpleLoadingIndicator.framework"
  install_framework "Pods-Juxt/MPCoachMarks.framework"
  install_framework "Pods-Juxt/Mixpanel.framework"
  install_framework "Pods-Juxt/Parse.framework"
  install_framework "Pods-Juxt/ParseFacebookUtilsV4.framework"
  install_framework "Pods-Juxt/ParseUI.framework"
  install_framework "Pods-Juxt/SCLAlertView.framework"
