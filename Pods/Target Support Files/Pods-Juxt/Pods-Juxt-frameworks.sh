...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Pods-Juxt/GTScrollNavigationBar.framework'
  ...
  install_framework 'Pods-Juxt/Realm.framework'
  install_framework 'Pods-Juxt/RealmSwift.framework'
